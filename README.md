...
<img width="273" alt="diagram" src="https://user-images.githubusercontent.com/84453422/133939291-83bc3d4a-54a9-4ad1-83f7-b93cd054575a.PNG">
...
|----------|----------|------------|------------------|
| Jump Box | Gateway  | 40.78.11.77| Linux            |
| DVWA-VM1 |    VM    | 10.0.0.5   | Linux            |
| DVWA-VM2 |    VM    | 10.0.0.6   | Linux            |
| ELK-VM   | ElkStack | 10.0.0.7   | Linux            |
